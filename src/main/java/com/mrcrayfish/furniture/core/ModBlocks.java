...
public class ModBlocks
{
    ...
    public static final RegistryObject<Block> PHOTO_FRAME_WHITE = register("white_photo_frame", () -> new PhotoFrameBlock(Block.Properties.copy(Blocks.BIRCH_PLANKS)));
    public static final RegistryObject<Block> PHOTO_FRAME_ORANGE = register("orange_photo_frame", () -> new PhotoFrameBlock(Block.Properties.copy(Blocks.BIRCH_PLANKS)));
    public static final RegistryObject<Block> PHOTO_FRAME_MAGENTA = register("magenta_photo_frame", () -> new PhotoFrameBlock(Block.Properties.copy(Blocks.BIRCH_PLANKS)));
    public static final RegistryObject<Block> PHOTO_FRAME_LIGHT_BLUE = register("light_blue_photo_frame", () -> new PhotoFrameBlock(Block.Properties.copy(Blocks.BIRCH_PLANKS)));
    public static final RegistryObject<Block> PHOTO_FRAME_YELLOW = register("yellow_photo_frame", () -> new PhotoFrameBlock(Block.Properties.copy(Blocks.BIRCH_PLANKS)));
    public static final RegistryObject<Block> PHOTO_FRAME_LIME = register("lime_photo_frame", () -> new PhotoFrameBlock(Block.Properties.copy(Blocks.BIRCH_PLANKS)));
    public static final RegistryObject<Block> PHOTO_FRAME_PINK = register("pink_photo_frame", () -> new PhotoFrameBlock(Block.Properties.copy(Blocks.BIRCH_PLANKS)));
    public static final RegistryObject<Block> PHOTO_FRAME_GRAY = register("gray_photo_frame", () -> new PhotoFrameBlock(Block.Properties.copy(Blocks.BIRCH_PLANKS)));
    public static final RegistryObject<Block> PHOTO_FRAME_LIGHT_GRAY = register("light_gray_photo_frame", () -> new PhotoFrameBlock(Block.Properties.copy(Blocks.BIRCH_PLANKS)));
    public static final RegistryObject<Block> PHOTO_FRAME_CYAN = register("cyan_photo_frame", () -> new PhotoFrameBlock(Block.Properties.copy(Blocks.BIRCH_PLANKS)));
    public static final RegistryObject<Block> PHOTO_FRAME_PURPLE = register("purple_photo_frame", () -> new PhotoFrameBlock(Block.Properties.copy(Blocks.BIRCH_PLANKS)));
    public static final RegistryObject<Block> PHOTO_FRAME_BLUE = register("blue_photo_frame", () -> new PhotoFrameBlock(Block.Properties.copy(Blocks.BIRCH_PLANKS)));
    public static final RegistryObject<Block> PHOTO_FRAME_BROWN = register("brown_photo_frame", () -> new PhotoFrameBlock(Block.Properties.copy(Blocks.BIRCH_PLANKS)));
